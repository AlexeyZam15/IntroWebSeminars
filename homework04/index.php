...
$city_country = "КнА, Россия";
$email = "www.random@mail.ru";
$telephone = "12312312";
$skills = [
    [
        'name' => 'Фотошоп',
...
$work_experience = [
    [
'name' => 'Фронт Энд Девелопер',
'date' => 'Янв 2015',
'description' => 'Очень классная работа. бла-бла-бла-бла.',
'current' => true,
],
[
'name' => 'Веб-девелопер / amazingsite.com',
'date' => 'Март 2012 - Дек 2014',
'description' => 'Действительно классная работа. Вау.',
'current' => false,
],
[
'name' => 'Графический дизайнер / amazingdesign.com',
'date' => 'Июнь 2010 - Март 2012',
'description' => 'Лучше дизайна сайта никто не делал.',
'current' => false,
],
];
?>
        ...
        <div class="w3-third">
            <div class="w3-white w3-text-grey w3-card-4">
                <div class="w3-display-container">
                    <img src="https://klike.net/uploads/posts/2020-10/1604129202_12.jpg"
    ...
    <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <?php for ($i = 0; $i < count($work_experience); $i++): ?>
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[$i]["date"]; ?> - <span
                        class="w3-tag w3-teal w3-round"><?php if($work_experience[$i]["current"]): echo "Текущая"; endif; ?></span></h6>
